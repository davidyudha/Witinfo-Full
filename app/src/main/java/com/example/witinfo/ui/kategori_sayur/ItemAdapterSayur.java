...
public class ItemAdapterSayur extends RecyclerView.Adapter<ItemAdapterSayur.ViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    private ArrayList<ItemDataSayur> values;
    private FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private DatabaseReference databaseReference = firebaseDatabase.getReference();
    private DatabaseReference first = databaseReference.child("image");

    public ItemAdapterSayur(Context context, ArrayList<ItemDataSayur> values) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = inflater.inflate(R.layout.item_list_sayur, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        final ItemDataSayur data=values.get(i);
        Glide.with( context)
                .load(data.pictK)
